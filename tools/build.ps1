...
$buildFolder='build_native410'
if($Public){$extra+=' -DLORABLE_PUBLIC_BUILD';$buildFolder='build_public410'}
if($Mode -eq 'Recovery'){
...
Write-Host 'Build only; no upload. Read VALIDATION-v410.md before flashing. Public builds exclude settings.local.h.'
